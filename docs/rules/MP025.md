...
## Auto-fix
`migrationpilot analyze <file> --fix` fixes this. Lift the CONCURRENTLY statement out of its BEGIN/COMMIT block when it is the first, last, or only statement in it.
