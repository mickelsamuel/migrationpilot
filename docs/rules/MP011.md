...
## Auto-fix
Not auto-fixable in one edit — the safe fix is a choreography. Unbatched UPDATE becomes a batched loop with its own lock_timeout and pauses between batches.
