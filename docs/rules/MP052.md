...
-- Same story: the view still names phone, and still parses, until it runs
```

Renaming a table (`ALTER TABLE users RENAME TO people`) is MP028, and renaming
a constraint or an index is neither -- this rule is about columns.
