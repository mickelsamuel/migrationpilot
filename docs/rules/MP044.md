...
## Auto-fix
Not auto-fixable in one edit — the safe fix is a choreography. Narrowing needs a pre-flight check that no row overflows, then the same expand-contract as MP007.
