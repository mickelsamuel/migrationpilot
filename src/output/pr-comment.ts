...
export function buildPRComment(analysis: PRAnalysisResult, rules?: Rule[]): string {
  ...
  if (!analysis.affectedQueries) {
    ...
    if (hasCriticalViolations) {
      lines.push(' · <a href="https://migrationpilot.dev/pricing">Try Pro free for 14 days</a> — see which production queries this migration will affect');
    } else {
      lines.push(' · <a href="https://migrationpilot.dev/pricing">Upgrade to Pro</a> for production context: table sizes, affected queries, service dependencies');
    }
  }
