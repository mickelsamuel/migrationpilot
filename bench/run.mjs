...
const DEFECTS = [
  {
    title: 'MigrationPilot: the MP084-MP112 batch cost precision, not recall',
    body: [
  ...
  {
    title: 'MigrationPilot: MP070 and MP097 cannot both be satisfied',
    body: [
  ...
  {
    title: 'MigrationPilot: MP097 treats every unique index as constraint-backed',
    body: [
  ...
  {
    title: 'The invalid-index retry trap, which only one tool now names',
    body: [
