...
export const metadata: Metadata = {
  ...
  description: 'Flyway runs migrations. MigrationPilot reviews them for safety. 112 rules catch lock issues, risky DDL, and missing best practices before your Flyway migration reaches production.',
  keywords: [
    'flyway alternative',
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="border border-line rounded-xl p-6 bg-surface">
                ...
                <ul className="space-y-3 text-sm text-muted">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-faint mt-0.5 shrink-0">--</span>
                    Does <strong className="text-muted">not</strong> analyze SQL for safety
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-faint mt-0.5 shrink-0">--</span>
                    Does <strong className="text-muted">not</strong> check lock impact
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-faint mt-0.5 shrink-0">--</span>
                    Does <strong className="text-muted">not</strong> suggest safe alternatives
                  </li>
                </ul>
              </div>
              <div className="border border-accent/35 rounded-xl p-6 bg-accent-soft">
                <div className="text-lg font-semibold mb-3 text-accent">MigrationPilot (Migration Linter)</div>
                <ul className="space-y-3 text-sm text-muted">
                  <li className="flex items-start gap-2">
                    <svg className="w-4 h-4 text-accent mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    112 safety rules for PostgreSQL DDL
                  </li>
                  <li className="flex items-start gap-2">
                    <svg className="w-4 h-4 text-accent mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              ...
              <table className="text-sm border border-line rounded-lg overflow-hidden">
                ...
                <tbody>
                  {[
                    ...
                    { feature: 'SQL safety analysis', flyway: 'No', mp: '112 rules' },
                    ...
                    { feature: 'Auto-fix', flyway: 'No', mp: '20 rules auto-fixable' },
                    ...
                    { feature: 'Pricing', flyway: 'Free Community / $$$$ Teams/Enterprise', mp: 'Free (all 112 rules)' },
                  ].map((row) => (
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                },
                {
                  ...
                  description: 'Point --database-url at a replica and 15 more rules read real table sizes, write traffic, replication state and index definitions. Read-only, and free like the rest.',
                },
              ].map((item) => (
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div className="min-w-0">
                  ...
                  <CodeBlock code={`# Analyze your Flyway migrations
        ...
        <section className="mp-container py-20 border-t border-line-soft">
          <div className="max-w-3xl">
            ...
            <p className="text-muted mb-8">
              112 safety rules. 20 auto-fixes. Lock analysis. Risk scoring. GitHub Action with PR comments.
