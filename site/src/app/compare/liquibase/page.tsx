            ...
            <table className="text-sm border border-slate-800 rounded-lg overflow-hidden">
              ...
              <tbody>
                {[
                  ...
                  { feature: 'Price', lbOss: 'Free', lbPro: 'Custom (enterprise)', mp: 'Free (all 83 rules)' },
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              },
              {
                ...
                description: 'Liquibase policy checks require a Pro or Enterprise license. MigrationPilot offers all 83 rules for free under an MIT license. No sales calls, no license keys for basic linting.',
              },
              {
