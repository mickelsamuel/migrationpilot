  ...
  return (
    <>
      ...
      <main className="pt-14">
        <div className="mp-container py-20">
          <h1 className="text-3xl font-bold text-fg mb-8">Privacy Policy</h1>
          <p className="text-sm text-faint mb-10">Last updated: August 12, 2026</p>

          <div className="space-y-8 leading-relaxed">
            <section>
              <h2 className="text-xl font-semibold text-fg mb-3">Overview</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-fg mb-3">CLI Tool</h2>
              <p>
                The MigrationPilot CLI runs entirely on your machine. It does <strong className="text-fg">not</strong> send
            ...
            <section>
              <h2 className="text-xl font-semibold text-fg mb-3">GitHub Action</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-fg mb-3">Website &amp; Billing</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-fg mb-3">Production Context</h2>
              <p>
                Production context analysis is optional and free. When enabled, MigrationPilot
                connects to your database to read <strong className="text-fg">only</strong> system catalog
                information (<code className="text-accent">pg_stat_user_tables</code>, <code className="text-accent">pg_class</code>,{' '}
                <code className="text-accent">pg_roles</code>). It never reads, modifies, or accesses your actual table data.
              </p>
            </section>

            <section>
              <h2 className="text-xl font-semibold text-fg mb-3">Data Retention</h2>
              <p>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-1">
                <li><strong className="text-fg">Stripe</strong>, payment processing (<a href="https://stripe.com/privacy" className="text-accent hover:underline">Stripe Privacy Policy</a>)</li>
                <li><strong className="text-fg">Resend</strong>, transactional email (<a href="https://resend.com/legal/privacy-policy" className="text-accent hover:underline">Resend Privacy Policy</a>)</li>
                <li><strong className="text-fg">Vercel</strong>, website hosting and analytics (<a href="https://vercel.com/legal/privacy-policy" className="text-accent hover:underline">Vercel Privacy Policy</a>)</li>
                <li><strong className="text-fg">GitHub</strong>, source code hosting and Actions (<a href="https://docs.github.com/en/site-policy/privacy-policies" className="text-accent hover:underline">GitHub Privacy Policy</a>)</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                <a href="mailto:hello@migrationpilot.dev" className="text-accent hover:underline">
          ...
          <div className="mt-16 pt-8 border-t border-line-soft">
            <a href="/" className="text-accent hover:underline">&larr; Back to MigrationPilot</a>
          </div>
        </div>
      </main>
      <Footer />
