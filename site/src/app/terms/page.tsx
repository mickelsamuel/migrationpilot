    ...
    <>
      ...
      <main className="pt-14">
        <div className="mp-container py-20">
          <h1 className="text-3xl font-bold text-fg mb-8">Terms of Service</h1>
          <p className="text-sm text-faint mb-10">Last updated: February 17, 2026</p>

          <div className="space-y-8 leading-relaxed">
            <section>
              <h2 className="text-xl font-semibold text-fg mb-3">1. Acceptance</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-fg mb-3">2. Service Description</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-fg mb-3">3. Free and Paid Tiers</h2>
              <p>
                All 112 safety rules, including production-context analysis via a database connection,
                are free and MIT licensed &mdash; no account or license key required. The only paid plan
                is Org ($499/year), which adds enforced policy, expiring owner-attributed waivers, and
                audit evidence for merges. It does not unlock any additional rules. Paid subscriptions
                are billed monthly or annually through Stripe.
              </p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-fg mb-3">4. License Keys</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-fg mb-3">6. Disclaimer of Warranties</h2>
              <p>
                MigrationPilot is a <strong className="text-fg">static analysis tool</strong> that provides recommendations
                based on known PostgreSQL patterns. It does <strong className="text-fg">not guarantee</strong> that your migrations
            ...
            <section>
              <h2 className="text-xl font-semibold text-fg mb-3">7. Limitation of Liability</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-fg mb-3">8. Open Source</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-fg mb-3">9. Changes to Terms</h2>
              <p>
