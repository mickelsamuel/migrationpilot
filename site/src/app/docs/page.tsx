    ...
    <main className="min-h-screen">
      ...
      <div className="pt-28 pb-20 px-6 max-w-5xl mx-auto">
        ...
        <section className="mb-16">
          ...
          <p className="text-slate-400 mb-6">83 safety rules covering locks, data safety, and best practices.</p>
          <a
            href="/docs/rules"
          ...
          >
            ...
            <p className="text-sm text-slate-400">Browse all 83 safety rules with severity, examples, and configuration.</p>
          </a>
        </section>
