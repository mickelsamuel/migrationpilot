    ...
    <main className="min-h-screen">
      ...
      <div className="pt-28 pb-20 px-6 max-w-5xl mx-auto">
        ...
        <section className="mb-16">
          ...
          <p className="text-slate-400 mb-6">{rules.length} safety rules covering locks, data safety, and best practices.</p>
          <a
            href="/rules"
          ...
          >
            ...
            <p className="text-sm text-slate-400">
              Browse all {rules.length} rules by what they act on, the lock they take, and what it
              takes to fix them.
            </p>
          </a>
        </section>
