        ...
        <article className="mp-container pt-16 md:pt-20 pb-20">
          <div className="max-w-3xl">
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <h2 className="text-2xl font-bold mt-12 mb-4 text-fg">Quick Comparison</h2>
                ...
                <table className="w-full text-sm border-collapse">
                  ...
                  <tbody className="text-muted">
                    <tr className="border-b border-line-soft">
                      <td className="py-3 px-4 font-semibold text-faint">Language</td>
                      <td className="py-3 px-4">Rust</td>
                      <td className="py-3 px-4">TypeScript</td>
                    </tr>
                    <tr className="border-b border-line-soft">
                      <td className="py-3 px-4 font-semibold text-faint">Safety rules</td>
                      <td className="py-3 px-4">40 (v2.62.0, Aug 2026)</td>
                      <td className="py-3 px-4">112 (all free)</td>
                    </tr>
                    <tr className="border-b border-line-soft">
                      <td className="py-3 px-4 font-semibold text-faint">Lock type classification</td>
                    ...
                    <tr className="border-b border-line-soft">
                      ...
                      <td className="py-3 px-4 text-danger">No</td>
                      <td className="py-3 px-4 text-ok">RED/YELLOW/GREEN</td>
                    </tr>
                    <tr className="border-b border-line-soft">
                    ...
                    <tr className="border-b border-line-soft">
                      ...
                      <td className="py-3 px-4 text-ok">Yes</td>
                      <td className="py-3 px-4 text-ok">Yes (with PR comments)</td>
                    </tr>
                    <tr className="border-b border-line-soft">
                    ...
                    <tr className="border-b border-line-soft">
                      <td className="py-3 px-4 font-semibold text-faint">Config file</td>
                      <td className="py-3 px-4 text-ok">.squawk.toml</td>
                      <td className="py-3 px-4 text-ok">.migrationpilotrc.yml</td>
                    </tr>
                    <tr className="border-b border-line-soft">
                      <td className="py-3 px-4 font-semibold text-faint">Output formats</td>
                      <td className="py-3 px-4">Text, TSV, JSON</td>
                      <td className="py-3 px-4">CLI, JSON, SARIF, Markdown</td>
                    </tr>
                    <tr className="border-b border-line-soft">
                      <td className="py-3 px-4 font-semibold text-faint">Production context</td>
                      <td className="py-3 px-4 text-danger">No</td>
                      <td className="py-3 px-4 text-ok">Yes (15 rules)</td>
                    </tr>
                    <tr className="border-b border-line-soft">
                      <td className="py-3 px-4 font-semibold text-faint">Community</td>
                      <td className="py-3 px-4 text-ok">~1,150 stars, ~1.4M npm downloads/mo</td>
                      <td className="py-3 px-4 text-warn">New project</td>
                    </tr>
                    <tr className="border-b border-line-soft">
                    ...
                    <tr className="border-b border-line-soft">
                      <td className="py-3 px-4 font-semibold text-faint">Price</td>
                      <td className="py-3 px-4 text-ok">Free (100%)</td>
                      <td className="py-3 px-4 text-ok">Free (100%)</td>
                    </tr>
                  </tbody>
                </table>
              ...
              <h2 className="text-2xl font-bold mt-12 mb-4 text-fg">Where Squawk Is Better</h2>

              <p className="text-muted leading-relaxed mb-4">
                Let&apos;s start with where Squawk wins. Being honest about this matters more than marketing.
              </p>

              <h3 className="text-xl font-semibold mt-8 mb-3 text-fg">1. Speed</h3>
              ...
              <h3 className="text-xl font-semibold mt-8 mb-3 text-fg">2. Maturity and community</h3>
              ...
              <h3 className="text-xl font-semibold mt-8 mb-3 text-fg">3. A single distribution</h3>

              <p className="text-muted leading-relaxed mb-6">
                Squawk is one Rust binary with no runtime to install. MigrationPilot needs Node 22+. Both
                tools are free &mdash; every MigrationPilot rule, including the 15 that read production
              ...
              <h2 className="text-2xl font-bold mt-12 mb-4 text-fg">Where MigrationPilot Is Better</h2>

              <h3 className="text-xl font-semibold mt-8 mb-3 text-fg">1. Rule depth (112 vs 40)</h3>

              <p className="text-muted leading-relaxed mb-4">
                MigrationPilot has 112 safety rules; Squawk has 40 as of v2.62.0 (Aug 2026). The extra ground covers:
              </p>
              ...
              <h3 className="text-xl font-semibold mt-8 mb-3 text-fg">2. Lock type classification</h3>
              ...
              <CodeBlock code={`# MigrationPilot output
...
migrations/001.sql:1:1: warning: prefer-create-index-concurrently
  Instead of \`CREATE INDEX\`, use \`CREATE INDEX CONCURRENTLY\`.`} />
              ...
              <h3 className="text-xl font-semibold mt-8 mb-3 text-fg">3. Auto-fix</h3>

              <p className="text-muted leading-relaxed mb-4">
                MigrationPilot can automatically fix 20 rule violations:
              </p>

              <CodeBlock code={`# Preview what would change
...
# After:  CREATE INDEX CONCURRENTLY idx_orders_customer ON orders (customer_id);`} />
              ...
              <p className="text-muted leading-relaxed mb-6">
                ...
                but you make the change manually. For the 20 rules MigrationPilot can auto-fix, the fix
                is a deterministic text transformation &mdash; not a heuristic guess.
              </p>

              <h3 className="text-xl font-semibold mt-8 mb-3 text-fg">4. Risk scoring and prioritization</h3>
              ...
              <h3 className="text-xl font-semibold mt-8 mb-3 text-fg">5. Multiple output formats</h3>
              ...
              <ul className="list-disc list-inside text-muted space-y-2 mb-6 ml-4">
                <li><strong className="text-fg">CLI</strong>: Colored terminal output with lock types, timing, and risk scores</li>
                <li><strong className="text-fg">JSON</strong>: Structured, versioned schema for programmatic consumption</li>
                <li><strong className="text-fg">SARIF</strong>: For GitHub Code Scanning and IDE integration</li>
                <li><strong className="text-fg">Markdown</strong>: For documentation, wikis, or PR comments</li>
              </ul>
              ...
              <h2 className="text-2xl font-bold mt-12 mb-4 text-fg">Rule Overlap</h2>
              ...
              <div className="overflow-x-auto mb-8">
                <table className="w-full text-sm border-collapse">
                  <thead>
                    <tr className="border-b border-line">
                      <th className="text-left py-3 px-4 text-muted font-semibold">Check</th>
                      <th className="text-left py-3 px-4 text-muted font-semibold">Squawk</th>
                      <th className="text-left py-3 px-4 text-muted font-semibold">MigrationPilot</th>
                    </tr>
                  </thead>
              ...
              <p className="text-muted leading-relaxed mb-6">
                ...
                The difference is breadth: MigrationPilot checks 112 rules to Squawk&apos;s 40, and the
                extra ground is mostly patterns Squawk does not look at.
              </p>

              <h2 className="text-2xl font-bold mt-12 mb-4 text-fg">CI Integration</h2>

              <p className="text-muted leading-relaxed mb-4">
                Both tools provide GitHub Actions. Here is how they look in a workflow:
              </p>

              <h3 className="text-xl font-semibold mt-8 mb-3 text-fg">Squawk GitHub Action</h3>

              <CodeBlock code={`- uses: sbdchd/squawk-action@v1
  with:
    pattern: "migrations/*.sql"`} />

              <h3 className="text-xl font-semibold mt-8 mb-3 text-fg">MigrationPilot GitHub Action</h3>
  ...
  with:
    ...
    fail-on: critical`} />
              ...
              <h2 className="text-2xl font-bold mt-12 mb-4 text-fg">Known Limitations</h2>

              <h3 className="text-xl font-semibold mt-8 mb-3 text-fg">Squawk&apos;s known issues</h3>
              ...
              <h3 className="text-xl font-semibold mt-8 mb-3 text-fg">MigrationPilot&apos;s known issues</h3>
              ...
              <ul className="list-disc list-inside text-muted space-y-2 mb-6 ml-4">
                ...
                <li>15 rules (including MP013, MP014, MP019) need a live <code className="rounded bg-raised px-1.5 py-0.5 font-mono text-[0.9em] text-fg">--database-url</code> to do anything</li>
                <li>No dynamic lock tracing (purely static analysis, like Squawk)</li>
              </ul>

              <h2 className="text-2xl font-bold mt-12 mb-4 text-fg">When to Use Squawk</h2>

              <ul className="list-disc list-inside text-muted space-y-2 mb-6 ml-4">
                <li><strong className="text-fg">You want a proven, battle-tested tool.</strong> Squawk has years of production usage and a larger community. If stability and track record matter most, use Squawk.</li>
                <li><strong className="text-fg">You want zero runtime dependencies.</strong> Squawk is a single Rust binary; MigrationPilot needs Node 22+.</li>
                <li><strong className="text-fg">You need Rust-native speed.</strong> If you lint thousands of migration files in CI, Squawk&apos;s Rust parser is faster.</li>
                <li><strong className="text-fg">You want minimal dependencies.</strong> Squawk is a single binary. MigrationPilot requires Node.js.</li>
              </ul>

              <h2 className="text-2xl font-bold mt-12 mb-4 text-fg">When to Use MigrationPilot</h2>

              <ul className="list-disc list-inside text-muted space-y-2 mb-6 ml-4">
                <li><strong className="text-fg">You want the deepest rule set.</strong> 112 rules cover patterns that Squawk&apos;s 40 rules do not check.</li>
                <li><strong className="text-fg">You want lock type information.</strong> Knowing <em>which</em> lock a statement acquires helps you assess real-world impact.</li>
                <li><strong className="text-fg">You want auto-fix.</strong> 20 rules can be automatically fixed with <code className="rounded bg-raised px-1.5 py-0.5 font-mono text-[0.9em] text-fg">--fix</code>.</li>
                <li><strong className="text-fg">You want SARIF output for GitHub Code Scanning.</strong> Violations appear directly in PR diffs.</li>
                <li><strong className="text-fg">You need production context analysis.</strong> Table size and query impact awareness is unique to MigrationPilot.</li>
                <li><strong className="text-fg">You want config presets.</strong> Five built-in presets (recommended, strict, ci, startup, enterprise) for different deployment contexts.</li>
              </ul>

              <h2 className="text-2xl font-bold mt-12 mb-4 text-fg">Can You Use Both?</h2>
    ...
    fail-on: critical`} />
              ...
              <div className="bg-surface border border-line rounded-lg p-6 mb-8">
                <ul className="list-disc list-inside text-muted space-y-3">
                  <li><strong className="text-fg">Squawk</strong> is the established choice: proven, fast, 100% free, and sufficient for catching the most common PostgreSQL migration hazards.</li>
                  <li><strong className="text-fg">MigrationPilot</strong> offers more coverage: 112 vs 40 rules, lock type classification, auto-fix, risk scoring, and SARIF output. But it&apos;s newer and less battle-tested.</li>
